...
public class MoveAction extends Action {
    ...
    public void moveTerritory(GameMap gameMap, int sourceTerritoryId, int targetTerritoryId) {
        ...
        if(checkMove == null){
            ...
            else if(gameMap.getTerritory(sourceTerritoryId).getAllyOwner() != -1 && this.owner.getId() == gameMap.getTerritory(sourceTerritoryId).getAllyOwner()){
    ...
    private void targetTerritoryReceive(GameMap gameMap, int targetTerritoryId, ArrayList<Integer> moved) {
        ...
        else if(gameMap.getTerritory(targetTerritoryId).getAllyOwner() != -1 && this.owner.getId() == gameMap.getTerritory(targetTerritoryId).getAllyOwner()){
