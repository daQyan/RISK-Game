...
public class ActionCheckerTest {
    ...
    public void testMoveRule(){
        ...
        MoveAction mv0 = new MoveAction(temp.get(0), temp.get(1), 1);
        MoveAction mv1 = new MoveAction(temp.get(0), temp.get(1), 6);
    ...
    public void testAttackRule(){
        ArrayList<Territory> temp = createTestHelper();
        AttackAction a0 = new AttackAction(temp.get(0), temp.get(1), 2);
        AttackAction a1 = new AttackAction(temp.get(0), temp.get(2), 2);
        AttackAction a2 = new AttackAction(temp.get(0), temp.get(1), 10);
