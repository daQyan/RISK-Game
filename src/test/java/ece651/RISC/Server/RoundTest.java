...
public class RoundTest {
    ...
    public void testAttackExecution(){
        ...
        mp.getTerritory(4).setAllyOwner(p0.getId());
        ...
        mp.getTerritory(6).setAllyOwner(p0.getId());
        mp.getTerritory(0).setAllyOwner(p2.getId());
        p0.setAllyPlayer(p2.getId());
        p2.setAllyPlayer(p0.getId());
